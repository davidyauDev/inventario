...
Route::get('/', function () {
    $salesOfMonth = \App\Models\Sale::whereMonth('date', now()->month)
        ->whereYear('date', now()->year)
        ->sum('total');

    $purchasesOfMonth = \App\Models\Purchase::whereMonth('date', now()->month)
        ->whereYear('date', now()->year)
        ->sum('total');
    ...
    return view('admin.dashboard', compact('salesOfMonth', 'purchasesOfMonth', 'productsCount', 'totalStock'));
})->name('dashboard');
